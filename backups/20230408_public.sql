...
--
-- Name: postags_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.postags ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.postags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COPY public.friendships (id, created_at, "userID", "friendID") FROM stdin;
\.
...
COPY public.postags (id, created_at, "postID", "tagID") FROM stdin;
11	2023-04-07 23:38:11.629784+00	100	food
\.
...
SELECT pg_catalog.setval('public.friendships_id_seq', 52, true);
...
--
-- Name: postags_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.postags_id_seq', 11, true);
...
ALTER TABLE ONLY public.postags
    ADD CONSTRAINT postags_pkey PRIMARY KEY (id);
...
--
-- Name: SEQUENCE postags_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.postags_id_seq TO anon;
GRANT ALL ON SEQUENCE public.postags_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.postags_id_seq TO service_role;
